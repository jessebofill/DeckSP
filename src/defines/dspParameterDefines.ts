import { DSPRangeParameter, DSPCompanderParameters, DSPParameterCompResponse, DSPParameterEQParameters, DSPEQParameters, DSPScaledParameter, DSPMappedParameter } from '../types/dspTypes';
